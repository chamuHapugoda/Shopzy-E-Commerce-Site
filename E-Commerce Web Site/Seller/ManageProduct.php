                    ...
                    <div class="modal-body p-4">
                        <form action="Backend/ManageProductBack.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control rounded-pill" id="seller_id" name="seller_id" placeholder="Enter Seller ID" value="<?php echo $id; ?>" readonly>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="product_image2" class="form-label">
                                        <i class="bi bi-image me-2"></i>Product Image 2
                                    </label>
                        ...
                        <tbody>
                            ...
                            if(isset($_REQUEST['Fillter'])){
                                if($_REQUEST['Fillter'] == 'Active'){
                                    $query = "SELECT * FROM products WHERE seller_id  = $id AND Status ='1'";
                                     $result = mysqli_query($conn, $query);
                                }
                                if($_REQUEST['Fillter'] == 'Inactive'){
                                    $query = "SELECT * FROM products WHERE seller_id  = $id AND Status = '0'";
                                    $result = mysqli_query($conn, $query);
                                }
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                            if (empty($row['image_url'])) {
                                                ...
                                                echo '<td><img src="../Product Image/' . htmlspecialchars($row['image_url']) . '" alt="Product Image 1"></td>';
                                            }

                                            if (empty($row['image2_url'])) {
                                                echo '<td>No Image</td>';
                                            } else { 
                                                echo '<td><img src="../Product Image/' . htmlspecialchars($row['image2_url']) . '" alt="Product Image 2"></td>';
                                            }
                                        ?>
                                        <td>
                                            <?php

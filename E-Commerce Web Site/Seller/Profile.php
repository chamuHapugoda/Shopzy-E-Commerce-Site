                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            if ($row['image'] == "") {
                                ...
                                echo "<img src='SellerImage/" . htmlspecialchars($row['image']) . "' alt='User Profile Image' class='profile-image'>";
                            }
                            ?>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="backend/UpdateProfile.php" method="post" enctype="multipart/form-data" onsubmit="return PersonalInformationValidations()" name="PersonalInformation">
                                ...
                                <div class="form-group row">
                                    <label for="FristName" class="col-sm-3 col-form-label">
                                        <i class="fas fa-user"></i> First Name
                                    </label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="FristName" name="FristName" value="<?php echo htmlspecialchars($row['first_name']); ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="business_name" class="col-sm-3 col-form-label">
                                        <i class="fas fa-building"></i> Business Name
                                    </label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="business_name" name="business_name" value="<?php echo htmlspecialchars($row['business_name']); ?>">
                                    </div>
                                </div>
                                <div class="form-group row">

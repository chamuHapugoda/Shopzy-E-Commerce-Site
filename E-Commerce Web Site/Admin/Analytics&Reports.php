...
<body>
    ...
    <div class="custom-container">
        <div class="grid">
            ...
            <div class="card bg-light">
                <div class="card-body">
                    <i class="bi bi-person-fill display-4 text-warning mb-3"></i>
                    <h5 class="card-title">Seller Count</h5>
                    <p class="card-text">Total Sellers: <span class="highlight"><?php echo $sellerCount; ?></span></p>
                    <p class="card-text">Active Sellers: <span class="highlightActive"> <?php echo $activeSellerCount; ?></p>
                    <p class="card-text">Online Sellers: <span class="highlightOnline"><?php echo $onlineSellerCount; ?></span></p>
                </div>
            </div>
            ...
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <p class="card-text">Total Customers: <span class="highlight"><?php echo $customerCount; ?></span></p>
                    <p class="card-text">Active Customers: <span class="highlightActive"> <?php echo $activeCustomerCount; ?></p>
                    <p class="card-text">Online Customers: <span class="highlight"><?php echo $onlineCustomerCount; ?></span></p>
                </div>
            </div>
            ...
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <p class="card-text">Total Subscribers: <span class="highlight"><?php echo $subcriberCount; ?></span></p>
                </div>
            </div>
